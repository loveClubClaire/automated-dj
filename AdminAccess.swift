...
class AdminAccess: NSObject {
    ...
    func getAdminAccess() -> Bool {
        ...
        let flags = AuthorizationFlags(rawValue: AuthorizationFlags.Defaults.rawValue |  AuthorizationFlags.InteractionAllowed.rawValue | AuthorizationFlags.ExtendRights.rawValue | AuthorizationFlags.DestroyRights.rawValue)
